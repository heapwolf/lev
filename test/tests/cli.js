...
test('Test Usage message', function(t) {
  ...
  exec(args.join(' '), function(err, stdout, stderr) {
    ...
    t.ok(stdout.indexOf('USAGE: lev') > -1)
    t.end()
  })
})

//
// TODO: this is all crap, rewrite all these tests for the cli.
//

// test('put to specific location', function(t) {
...
//     t.equals(test_output1, OK)
//       if (err) { return t.notOk(true, err) }

//       db.get(test_key1, function (err, value) {
//         if (err) { return t.notOk(true, err) }
//         t.equals(test_value1, value, "Value stored and retrieved as expected")
//         db.close()
//         t.end()
//       })
//     })
...
// test('put to specific location without -c (Verbose)', function(t) {
...
//    t.equals(test_output1, OK, "Output validated")
...
//        if (err) { return t.notOk(true, err) }
//        t.equals(test_value2, value, "Insert Validated" )
//        db.close()
//        t.end()
//      })
//    })
...
// test('put from within the current working dir', function(t) {
...
// test('put from within the current working dir (Verbose)', function(t) {
