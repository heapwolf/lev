...
errors.NotFoundError = function() {
  ...
  return console.log(
    'No such key', 
    key[1].replace(new RegExp('\xff', 'g'), '/')
  )
}
...
function setupContextMethods() {
  ...
  REPL.context.cd = function(opts) {
    ...
    var sl = (opts.rest && opts.rest[0]) || opts
  ...
  REPL.context.ls = function(opts) {
    ...
    if (opts.rest) {
      opts = { start: opts.rest[0], limit: (parseInt(opts.rest[1]) || -1) }
    }
  ...
  REPL.context.get = function(opts, callback) {
    ...
    callback = callback || print
    key = (opts.rest && opts.rest[0]) || opts
  ...
  REPL.context.put = function(opts, val, callback) {
  ...
  var specialMethods = ['ls', 'format', 'cd', 'pwd', 'get', 'put', 'del']
